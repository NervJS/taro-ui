      ...
      <View className='page'>
        ...
        <View className='doc-body'>
          ...
          <View className='panel'>
            ...
            <View className='panel__content'>
              <View className='example-item'>
                <AtButton onClick={this.handleClick.bind(this, 1)}>打开 Float Layout</AtButton>
              </View>
            </View>
          </View>
          ...
          <View className='panel'>
            ...
            <View className='panel__content'>
              <View className='example-item'>
                <AtButton onClick={this.handleClick.bind(this, 2)}>打开 Float Layout</AtButton>
              </View>
            </View>
          </View>
        </View>

        <AtFloatLayout title='这是个标题' isOpened={isOpened1}>
